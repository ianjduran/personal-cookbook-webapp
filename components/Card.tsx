...
function RecipeCard(props: { category: string, label: string, href: string }) {
  return (
    <Link href={`${props.href}`} className={`relative py-2 px-2 pb-4 bg-gradient-to-r from-cyan-500 to-blue-500 border inline-block h-40 w-[calc(50%_-_1rem)] rounded-md max-w-[20rem] border-none hover:shadow-lg`} >
