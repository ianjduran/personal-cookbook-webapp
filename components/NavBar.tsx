...
function NavBar() {
  return (
    <nav className='block container fixed shadow-[0_0px_14px_0_rgba(0,0,0,0.1)] left-auto bottom-0 bg-white h-14 w-screen dark:bg-gray-800
      ...
      <ul className='flex flex-row items-center justify-around my-3 tablet:gap-7 tablet:my-5 tablet:flex-col md:flex-inline md:justify-start md:items-start md:ml-4'>
        <div className="items-center justify-center hidden object-center w-full -ml-2 text-xl text-red-500 md:inline-flex">
          <HiOutlineFire className="inline w-6 h-6" style={{ strokeWidth: 1.9 }} />


          <span className="ml-2 font-bold font-header ">Recetario</span>
        </div>
        <li className="transition-all ease-out pb-1 hover:border-b-[3px] hover:border-b-slate-900 dark:hover:border-b-slate-200
          ...
          <Link href="/">
            ...
            <div className="flex flex-row items-center flex-inline">
              ...
              <span className="hidden ml-3 text-sm font-bold md:inline font-header">Inicio</span>
            </div>
        ...
        <li className="transition-all ease-out pb-1 hover:border-b-[3px] hover:border-b-slate-900 dark:hover:border-b-slate-200
          ...
          <Link href="/recipes/create">
            ...
            <div className="flex flex-row items-center flex-inline ">
              ...
              <span className="hidden ml-3 text-sm font-bold md:inline font-header">Añadir Receta</span>
        ...
        <li className="transition-all ease-out pb-1 hover:border-b-[3px] hover:border-b-slate-900 dark:hover:border-b-slate-200
          ...
          <Link href="/recipes">
            ...
            <div className="flex flex-row items-center flex-inline">
              ...
              <span className="hidden ml-3 text-sm font-bold md:inline font-header">Recetas</span>
