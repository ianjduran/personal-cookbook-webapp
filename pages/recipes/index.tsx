...
function RecipeListPage() {
      ...
      <Layout>
        ...
        {isLoading && (
          <div className="flex flex-wrap mt-4 gap-4 md:gap-x-4">
            <div
              className={`relative py-2 px-2 pb-4 bg-gray-300 border inline-block h-40 w-[calc(50%_-_1rem)] rounded-md max-w-[20rem]`}
            />
            <div
              className={`relative py-2 px-2 pb-4 bg-gray-300 border inline-block h-40 w-[calc(50%_-_1rem)] rounded-md max-w-[20rem]`}
            />
  ...
  return (
    <Layout>
      ...
      {data && data.allRecipes.length < 1 ? (
        <div className="mt-20 ">
          <div className="flex flex-col items-center content-center justify-center align-middle ">
            <div className="mb-4">
              <Image
                src={"/empty-recipe-list.svg"}
                alt={"Empty Recipe List Illustration"}
                width={300}
                height={300}
              />
            </div>
